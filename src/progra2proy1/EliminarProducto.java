...
public class EliminarProducto extends javax.swing.JFrame {
    ...
    public EliminarProducto(String Sucursal) {
        initComponents();
    ...
    private void initComponents() {
        ...
        btnEliminar.setIcon(new javax.swing.ImageIcon(getClass().getResource("/progra2proy1/imagenes/trash.png"))); // NOI18N
        ...
        if (rbtID.isSelected()) {
            for (int i = 0; i < listas.ObtenerListaProductos().size(); i++) {
                if (listas.ObtenerListaProductos().get(i).getIDProd().equalsIgnoreCase(txfFiltro.getText())) {
                    listas.ObtenerListaProductos().remove(i);
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new EliminarProducto(Sucursal).setVisible(true);
            }
        });
    }
